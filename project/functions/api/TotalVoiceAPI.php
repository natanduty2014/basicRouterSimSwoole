...
class TotalVoiceAPI
{
    ...
    private function sendRequest($path, $method, $body = null)
    {
        ...
        $request = curl_init();
        curl_setopt($request, CURLOPT_URL, "https://voice-api.zenvia.com" . $path);
    ...
    /* Audio */
    public function enviaAudio($numeroDestino, $urlAudio, $respostaUsuario = false, $gravar_audio = false, $bina = "")
    {
        $body = array();
        $body['numero_destino'] = $numeroDestino;
